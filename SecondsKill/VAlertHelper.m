...
{
    ALAlertBanner *banner = [ALAlertBanner alertBannerForView:view style:ALAlertBannerStyleNotify position:ALAlertBannerPositionTop title:@"数据请求成功!" subtitle:nil tappedBlock:^(ALAlertBanner *alertBanner) {
        [alertBanner hide];
    }];
...
{
    ALAlertBanner *banner = [ALAlertBanner alertBannerForView:view style:ALAlertBannerStyleFailure position:ALAlertBannerPositionTop title:@"数据请求失败，请重试!" subtitle:nil tappedBlock:^(ALAlertBanner *alertBanner) {
        [alertBanner hide];
    }];
...
{
    ALAlertBanner *banner = [ALAlertBanner alertBannerForView:view style:ALAlertBannerStyleFailure position:ALAlertBannerPositionTop title:@"网络异常！" subtitle:nil tappedBlock:^(ALAlertBanner *alertBanner) {
        [alertBanner hide];
    }];
...
{
    ALAlertBanner *banner = [ALAlertBanner alertBannerForView:view style:ALAlertBannerStyleFailure position:ALAlertBannerPositionTop title:message subtitle:nil tappedBlock:^(ALAlertBanner *alertBanner) {
        [alertBanner hide];
    }];
