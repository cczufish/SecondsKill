...
// AutoDescribe
#define COCOAPODS_POD_AVAILABLE_AutoDescribe
#define COCOAPODS_VERSION_MAJOR_AutoDescribe 1
#define COCOAPODS_VERSION_MINOR_AutoDescribe 0
#define COCOAPODS_VERSION_PATCH_AutoDescribe 0
